...
const Hero = () => {
  return (
    <div className="hero-bg min-h-[50vh] md:h-[80vh] text-white text-5xl flex flex-col justify-center py-20 px-8 space-y-28 absolute -z-10">
      <div>
        <h2 className="text-white md:text-7xl text-4xl md:leading-[1.2] leading-[1.4] min-w-96">
