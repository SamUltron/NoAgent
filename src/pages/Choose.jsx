...
const Choose = () => {
  return (
    <div className="flex flex-col items-center bg-[#F5F5F5] h-1/2 mt-20 py-20 px-5">
      <h2 className="md:text-6xl text-4xl text-center font-semibold">Why Choose NoAgent?</h2>
      ...
      <div className="grid md:grid-cols-2  w-full lg:grid-cols-4 grid-cols-1 gap-8 mt-20 px-2 fade-in-from-ground">
        {chooses.map((choose) => (
