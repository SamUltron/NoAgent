...
const How = () => {
  return (
    <div className="flex flex-col items-center bg-[#F5F5F5] h-1/2 mt-20 relative z-0 py-20 px-5">
      <h2 className="md:text-6xl text-4xl text-center font-semibold min-w-md">How NoAgent Works</h2>
